...
namespace OpenETaxBill.Channel.Interface
{
    ...
    /// CProxy에 대한 요약 설명입니다.
    /// </summary>
    public class IReporter : IDisposable
    {
        //-------------------------------------------------------------------------------------------------------------------------
        //
        //-------------------------------------------------------------------------------------------------------------------------
        ...
        public IReporter(bool p_isService)
        {
            ...
            get
            {
                if (m_wcfProxy == null)
                {
                    m_wcfProxy = new OdinSdk.OdinLib.Communication.WcfProxy
                        (
                        "Open-eTaxBill Reporting Service V1.0",             // Service Description

                        new string[] { "net.tcp", "BasicHttpBinding" },     // Binding Names
                        "",                                                 // Ip Address
                        new int[] { 8471, 8472 },                           // Service Ports
                        8473,                                               // Behavior Port

                        "OpenETaxBill_Report_V10.soap",                    // Soap Url
                        "reporter",                                         // Event Source

                        "194C7E3D-E437-4371-BDE6-9E14E8E16DD0",             // Application GUID

                        "OpenTAX_DBC_REPORT",                                  // Application Connection
                        "WcfReporterUrl",                                   // Application Configure

                        "tcp",                                              // MSMQ Protocol Name

                        "bizapp",                                           // Category Id
                        "OpenTAX_Reporter",                                    // Application ServiceId
                        "OpenTAX_Reporter_V10",                                // Service Name
