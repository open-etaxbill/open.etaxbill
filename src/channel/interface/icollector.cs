...
namespace OpenETaxBill.Channel.Interface
{
    ...
    /// CProxy에 대한 요약 설명입니다.
    /// </summary>
    public class ICollector : IDisposable
    {
        //-------------------------------------------------------------------------------------------------------------------------
        //
        //-------------------------------------------------------------------------------------------------------------------------
        ...
        public ICollector(bool p_isService)
        {
            ...
            get
            {
                if (m_wcfProxy == null)
                {
                    m_wcfProxy = new OdinSdk.OdinLib.Communication.WcfProxy
                        (
                        "Open-eTaxBill Collecting Service V1.0",            // Service Description

                        new string[] { "net.tcp", "BasicHttpBinding" },     // Binding Names
                        "",                                                 // Ip Address
                        new int[] { 8460, 8461 },                           // Service Ports
                        8462,                                               // Behavior Port

                        "OpenETaxBill_Collect_V10.soap",                    // Soap Url
                        "collector",                                        // Event Source

                        "46205BCB-57B9-4EF9-A6EA-D6052AA797DB",             // Application GUID

                        "OpenTAX_DBC_COLLECT",                              // Application Connection
                        "WcfCollectorUrl",                                  // Application Configure

                        "tcp",                                              // MSMQ Protocol Name

                        "bizapp",                                           // Category Id
                        "OpenTAX_Collector",                                // Application ServiceId
                        "OpenTAX_Collector_V10",                            // Service Name
