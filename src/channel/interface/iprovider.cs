...
namespace OpenETaxBill.Channel.Interface
{
    ...
    /// CProxy에 대한 요약 설명입니다.
    /// </summary>
    public class IProvider : IDisposable
    {
        //-------------------------------------------------------------------------------------------------------------------------
        //
        //-------------------------------------------------------------------------------------------------------------------------
        ...
        public IProvider(bool p_isService)
        {
            ...
            get
            {
                if (m_wcfProxy == null)
                {
                    m_wcfProxy = new OdinSdk.OdinLib.Communication.WcfProxy
                        (
                        "Open-eTaxBill Providing Service V1.0",             // Service Description

                        new string[] { "net.tcp", "BasicHttpBinding" },     // Binding Names
                        "",                                                 // Ip Address
                        new int[] { 8468, 8469 },                           // Service Ports
                        8470,                                               // Behavior Port

                        "OpenETaxBill_ASP_V10.soap",                       // Soap Url
                        "provider",                                         // Event Source

                        "8F355805-9926-45A6-902D-A1B4AF6B77C4",             // Application GUID

                        "OpenTAX_DBC_MAIL",                                    // Application Connection
                        "WcfProviderUrl",                                   // Application Configure

                        "tcp",                                              // MSMQ Protocol Name

                        "bizapp",                                           // Category Id
                        "OpenTAX_Provider",                                    // Application ServiceId
                        "OpenTAX_Provider_V10",                                // Service Name
